package neil.com.brotherrx.ui.grab;
...
public class GrabMainActivity extends BaseActivity {
    @Override
    ...
    private void init() {
        ...
        lineViewPager.setAdapter(new TabAdapter(this.getSupportFragmentManager(), fragments, titles));
        lineTabLayout.setupWithViewPager(lineViewPager);
        setIndicator(this, lineTabLayout, 10, 10);
        //添加分割线
