 ...
 */
public class NFooterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener, View.OnLongClickListener {
    ...
    public NFooterAdapter(NRecyclerView nRecyclerView, LoadingMoreFooter loadingMoreFooter, RecyclerView.Adapter adapter) {
    ...
    public void onClick(View view) {
        if (onItemClickListener != null) {
            onItemClickListener.onItemClick(null, view, nRecyclerView.getChildAdapterPosition(view), 0);
        }
    }
    ...
    public boolean onLongClick(View view) {
        if (onItemLongClickListener != null) {
            onItemLongClickListener.onItemLongClick(null, view, nRecyclerView.getChildAdapterPosition(view), 0);
        }
        return true;
    }
