...
/**
 * Created by neil on 2017/7/1 18：31.
 */
public class RecycleViewGridDivider extends RecyclerView.ItemDecoration {
    ...
    public RecycleViewGridDivider(int space) {
        this.space = space;
    }

//    public RecycleViewGridDivider(int space, int color) {
//        this.space = space;
//        this.color = color;
...
//    }
    ...
    public RecycleViewGridDivider(int space, int color, int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public RecycleViewGridDivider(int space, Drawable mDivider) {
        this.space = space;
